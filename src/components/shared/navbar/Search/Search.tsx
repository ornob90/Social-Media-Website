    ...
    <div className="w-full md:w-[60%] lg:w-[30%] md:ml-16 rounded-xl ">
      <form className="relative ">
        <input
          ...
          type="text"
          className="w-full py-2 rounded-xl bg-light-gray dark:bg-dark-gray dark:placeholder:text-white  placeholder:text-dark-gray  pl-9 text-sm  focus:outline-none"
          placeholder="Search"
        />
        {/* Search Icon  */}
